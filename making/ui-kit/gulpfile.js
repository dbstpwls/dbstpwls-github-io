/*! gulpfile.js v1.0.0 © https://gitlab.dev.dnm.com/publishing/map */
...
// 폴더 제거 업무
// =======================================
gulp.task('remove', shell.task('rm -rf ' + BUILD + ' ' + BUILD + '/assets/stylesheets/map ' + BUILD + '/assets/stylesheets/dum_style.css '));
